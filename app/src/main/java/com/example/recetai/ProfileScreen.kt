        ...
        Column(
            ...
            Row(modifier = Modifier.fillMaxWidth().padding(vertical = 8.dp)) {
                Button(onClick = onNavigateToLogin, modifier = Modifier.weight(1f)) {
                    Icon(Icons.Default.Lock, contentDescription = null) // Aquí usamos Lock
                    Spacer(modifier = Modifier.width(8.dp))
                    Text("Login")
                }
                Spacer(modifier = Modifier.width(8.dp))
                OutlinedButton(onClick = onNavigateToRegister, modifier = Modifier.weight(1f)) {
            ...
            // LEGAL
            Text(text = "Soporte", style = MaterialTheme.typography.titleMedium, modifier = Modifier.fillMaxWidth())
